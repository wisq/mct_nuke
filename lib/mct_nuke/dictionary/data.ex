...
defmodule MctNuke.Dictionary.Data do
  ...
  @metrics [
    ...
    %Metric{name: "Coolant Core Circulation Pump 0 Status", key: "COOLANT_CORE_CIRCULATION_PUMP_0_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 1 Status", key: "COOLANT_CORE_CIRCULATION_PUMP_1_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 2 Status", key: "COOLANT_CORE_CIRCULATION_PUMP_2_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 0 Dry Status", key: "COOLANT_CORE_CIRCULATION_PUMP_0_DRY_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 1 Dry Status", key: "COOLANT_CORE_CIRCULATION_PUMP_1_DRY_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 2 Dry Status", key: "COOLANT_CORE_CIRCULATION_PUMP_2_DRY_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 0 Overload Status", key: "COOLANT_CORE_CIRCULATION_PUMP_0_OVERLOAD_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 1 Overload Status", key: "COOLANT_CORE_CIRCULATION_PUMP_1_OVERLOAD_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 2 Overload Status", key: "COOLANT_CORE_CIRCULATION_PUMP_2_OVERLOAD_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 0 Ordered Speed", key: "COOLANT_CORE_CIRCULATION_PUMP_0_ORDERED_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Core Circulation Pump 1 Ordered Speed", key: "COOLANT_CORE_CIRCULATION_PUMP_1_ORDERED_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Core Circulation Pump 2 Ordered Speed", key: "COOLANT_CORE_CIRCULATION_PUMP_2_ORDERED_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Core Circulation Pump 0 Speed", key: "COOLANT_CORE_CIRCULATION_PUMP_0_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Core Circulation Pump 1 Speed", key: "COOLANT_CORE_CIRCULATION_PUMP_1_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Core Circulation Pump 2 Speed", key: "COOLANT_CORE_CIRCULATION_PUMP_2_SPEED", format: :float, units: "%"},
    ...
    %Metric{name: "Generator 0 Power", key: "GENERATOR_0_KW", format: :float, units: "kW"},
    %Metric{name: "Generator 1 Power", key: "GENERATOR_1_KW", format: :float, units: "kW"},
    %Metric{name: "Generator 2 Power", key: "GENERATOR_2_KW", format: :float, units: "kW"},
    %Metric{name: "Generator 0 Voltage", key: "GENERATOR_0_V", format: :float, units: "V"},
    %Metric{name: "Generator 1 Voltage", key: "GENERATOR_1_V", format: :float, units: "V"},
    %Metric{name: "Generator 2 Voltage", key: "GENERATOR_2_V", format: :float, units: "V"},
    %Metric{name: "Generator 0 Amperage", key: "GENERATOR_0_A", format: :float, units: "A"},
    %Metric{name: "Generator 1 Amperage", key: "GENERATOR_1_A", format: :float, units: "A"},
    %Metric{name: "Generator 2 Amperage", key: "GENERATOR_2_A", format: :float, units: "A"},
    %Metric{name: "Generator 0 Hertz", key: "GENERATOR_0_HERTZ", format: :float, units: "Hz"},
    %Metric{name: "Generator 1 Hertz", key: "GENERATOR_1_HERTZ", format: :float, units: "Hz"},
    %Metric{name: "Generator 2 Hertz", key: "GENERATOR_2_HERTZ", format: :float, units: "Hz"},
    %Metric{name: "Generator 0 Breaker", key: "GENERATOR_0_BREAKER", format: :boolean, units: nil},
    %Metric{name: "Generator 1 Breaker", key: "GENERATOR_1_BREAKER", format: :boolean, units: nil},
    %Metric{name: "Generator 2 Breaker", key: "GENERATOR_2_BREAKER", format: :boolean, units: nil},
    %Metric{name: "Steam Turbine 0 RPM", key: "STEAM_TURBINE_0_RPM", format: :float, units: "RPM"},
    %Metric{name: "Steam Turbine 1 RPM", key: "STEAM_TURBINE_1_RPM", format: :float, units: "RPM"},
    %Metric{name: "Steam Turbine 2 RPM", key: "STEAM_TURBINE_2_RPM", format: :float, units: "RPM"},
    %Metric{name: "Steam Turbine 0 Temperature", key: "STEAM_TURBINE_0_TEMPERATURE", format: :float, units: "℃"},
    %Metric{name: "Steam Turbine 1 Temperature", key: "STEAM_TURBINE_1_TEMPERATURE", format: :float, units: "℃"},
    %Metric{name: "Steam Turbine 2 Temperature", key: "STEAM_TURBINE_2_TEMPERATURE", format: :float, units: "℃"},
    %Metric{name: "Steam Turbine 0 Pressure", key: "STEAM_TURBINE_0_PRESSURE", format: :float, units: "bar"},
    %Metric{name: "Steam Turbine 1 Pressure", key: "STEAM_TURBINE_1_PRESSURE", format: :float, units: "bar"},
    %Metric{name: "Steam Turbine 2 Pressure", key: "STEAM_TURBINE_2_PRESSURE", format: :float, units: "bar"},
    %Metric{name: "Steam Turbine 0 Torque", key: "STEAM_TURBINE_0_TORQUE", format: :float, units: "%"},
    %Metric{name: "Steam Turbine 1 Torque", key: "STEAM_TURBINE_1_TORQUE", format: :float, units: "%"},
    %Metric{name: "Steam Turbine 2 Torque", key: "STEAM_TURBINE_2_TORQUE", format: :float, units: "%"},
    %Metric{name: "Steam Turbine 0 Installed", key: "STEAM_TURBINE_0_INSTALLED", format: :boolean, units: nil},
    %Metric{name: "Steam Turbine 1 Installed", key: "STEAM_TURBINE_1_INSTALLED", format: :boolean, units: nil},
    %Metric{name: "Steam Turbine 2 Installed", key: "STEAM_TURBINE_2_INSTALLED", format: :boolean, units: nil},
    %Metric{name: "Steam Generator 0 Status", key: "STEAM_GEN_0_STATUS", format: :integer, units: nil},
    %Metric{name: "Steam Generator 1 Status", key: "STEAM_GEN_1_STATUS", format: :integer, units: nil},
    %Metric{name: "Steam Generator 2 Status", key: "STEAM_GEN_2_STATUS", format: :integer, units: nil},
    ...
    %Metric{name: "Coolant Secondary Circulation Pump 0 Status", key: "COOLANT_SEC_CIRCULATION_PUMP_0_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 1 Status", key: "COOLANT_SEC_CIRCULATION_PUMP_1_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 2 Status", key: "COOLANT_SEC_CIRCULATION_PUMP_2_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 0 Dry Status", key: "COOLANT_SEC_CIRCULATION_PUMP_0_DRY_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 1 Dry Status", key: "COOLANT_SEC_CIRCULATION_PUMP_1_DRY_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 2 Dry Status", key: "COOLANT_SEC_CIRCULATION_PUMP_2_DRY_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 0 Overload Status", key: "COOLANT_SEC_CIRCULATION_PUMP_0_OVERLOAD_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 1 Overload Status", key: "COOLANT_SEC_CIRCULATION_PUMP_1_OVERLOAD_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 2 Overload Status", key: "COOLANT_SEC_CIRCULATION_PUMP_2_OVERLOAD_STATUS", format: :integer, units: nil},
    %Metric{name: "Coolant Secondary Circulation Pump 0 Ordered Speed", key: "COOLANT_SEC_CIRCULATION_PUMP_0_ORDERED_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Secondary Circulation Pump 1 Ordered Speed", key: "COOLANT_SEC_CIRCULATION_PUMP_1_ORDERED_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Secondary Circulation Pump 2 Ordered Speed", key: "COOLANT_SEC_CIRCULATION_PUMP_2_ORDERED_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Secondary Circulation Pump 0 Speed", key: "COOLANT_SEC_CIRCULATION_PUMP_0_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Secondary Circulation Pump 1 Speed", key: "COOLANT_SEC_CIRCULATION_PUMP_1_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Secondary Circulation Pump 2 Speed", key: "COOLANT_SEC_CIRCULATION_PUMP_2_SPEED", format: :float, units: "%"},
    %Metric{name: "Coolant Secondary 0 Volume", key: "COOLANT_SEC_0_VOLUME", format: :float, units: "hL"},
    %Metric{name: "Coolant Secondary 1 Volume", key: "COOLANT_SEC_1_VOLUME", format: :float, units: "hL"},
    %Metric{name: "Coolant Secondary 2 Volume", key: "COOLANT_SEC_2_VOLUME", format: :float, units: "hL"},
    %Metric{name: "Coolant Secondary 0 Liquid Volume", key: "COOLANT_SEC_0_LIQUID_VOLUME", format: :float, units: "hL"},
    %Metric{name: "Coolant Secondary 1 Liquid Volume", key: "COOLANT_SEC_1_LIQUID_VOLUME", format: :float, units: "hL"},
    %Metric{name: "Coolant Secondary 2 Liquid Volume", key: "COOLANT_SEC_2_LIQUID_VOLUME", format: :float, units: "hL"},
    %Metric{name: "Coolant Secondary 0 Pressure", key: "COOLANT_SEC_0_PRESSURE", format: :float, units: "bar"},
    %Metric{name: "Coolant Secondary 1 Pressure", key: "COOLANT_SEC_1_PRESSURE", format: :float, units: "bar"},
    %Metric{name: "Coolant Secondary 2 Pressure", key: "COOLANT_SEC_2_PRESSURE", format: :float, units: "bar"},
    %Metric{name: "Coolant Secondary 0 Temperature", key: "COOLANT_SEC_0_TEMPERATURE", format: :float, units: "℃"},
    %Metric{name: "Coolant Secondary 1 Temperature", key: "COOLANT_SEC_1_TEMPERATURE", format: :float, units: "℃"},
    %Metric{name: "Coolant Secondary 2 Temperature", key: "COOLANT_SEC_2_TEMPERATURE", format: :float, units: "℃"},
    ...
    %Metric{name: "MSCV 0 Opening Actual", key: "MSCV_0_OPENING_ACTUAL", format: :float, units: "%"},
    %Metric{name: "MSCV 1 Opening Actual", key: "MSCV_1_OPENING_ACTUAL", format: :float, units: "%"},
    %Metric{name: "MSCV 2 Opening Actual", key: "MSCV_2_OPENING_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Steam Turbine 0 Bypass Actual", key: "STEAM_TURBINE_0_BYPASS_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Steam Turbine 1 Bypass Actual", key: "STEAM_TURBINE_1_BYPASS_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Steam Turbine 2 Bypass Actual", key: "STEAM_TURBINE_2_BYPASS_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Steam Generator 0 Outlet", key: "STEAM_GEN_0_OUTLET", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 0 Evaporated", key: "STEAM_GEN_0_EVAPORATED", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 0 Boiling Point", key: "STEAM_GEN_0_BOILING_POINT", format: :float, units: "℃"},
    %Metric{name: "Steam Generator 0 Inlet", key: "STEAM_GEN_0_INLET", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 0 Return Flow Plus Condensed", key: "STEAM_GEN_0_RETURN_FLOW_PLUS_CONDENSED", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 1 Outlet", key: "STEAM_GEN_1_OUTLET", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 1 Evaporated", key: "STEAM_GEN_1_EVAPORATED", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 1 Boiling Point", key: "STEAM_GEN_1_BOILING_POINT", format: :float, units: "℃"},
    %Metric{name: "Steam Generator 1 Inlet", key: "STEAM_GEN_1_INLET", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 1 Return Flow Plus Condensed", key: "STEAM_GEN_1_RETURN_FLOW_PLUS_CONDENSED", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 2 Outlet", key: "STEAM_GEN_2_OUTLET", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 2 Evaporated", key: "STEAM_GEN_2_EVAPORATED", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 2 Boiling Point", key: "STEAM_GEN_2_BOILING_POINT", format: :float, units: "℃"},
    %Metric{name: "Steam Generator 2 Inlet", key: "STEAM_GEN_2_INLET", format: :float, units: "kg/min"},
    %Metric{name: "Steam Generator 2 Return Flow Plus Condensed", key: "STEAM_GEN_2_RETURN_FLOW_PLUS_CONDENSED", format: :float, units: "kg/min"},
    ...
    %Metric{name: "Steam Generator 0 Vent Switch", key: "STEAM_GEN_0_VENT_SWITCH", format: :boolean, units: nil},
    %Metric{name: "Steam Generator 1 Vent Switch", key: "STEAM_GEN_1_VENT_SWITCH", format: :boolean, units: nil},
    %Metric{name: "Steam Generator 2 Vent Switch", key: "STEAM_GEN_2_VENT_SWITCH", format: :boolean, units: nil},
    %Metric{name: "Coolant Core Circulation Pump 0 Capacity", key: "COOLANT_CORE_CIRCULATION_PUMP_0_CAPACITY", format: :float, units: "L/m"},
    %Metric{name: "Coolant Core Circulation Pump 1 Capacity", key: "COOLANT_CORE_CIRCULATION_PUMP_1_CAPACITY", format: :float, units: "L/m"},
    %Metric{name: "Coolant Core Circulation Pump 2 Capacity", key: "COOLANT_CORE_CIRCULATION_PUMP_2_CAPACITY", format: :float, units: "L/m"},
    %Metric{name: "Coolant Secondary Circulation Pump 0 Capacity", key: "COOLANT_SEC_CIRCULATION_PUMP_0_CAPACITY", format: :float, units: "L/m"},
    %Metric{name: "Coolant Secondary Circulation Pump 1 Capacity", key: "COOLANT_SEC_CIRCULATION_PUMP_1_CAPACITY", format: :float, units: "L/m"},
    %Metric{name: "Coolant Secondary Circulation Pump 2 Capacity", key: "COOLANT_SEC_CIRCULATION_PUMP_2_CAPACITY", format: :float, units: "L/m"},
    %Metric{name: "Control Rod Bank Pos 0 Ordered", key: "ROD_BANK_POS_0_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 0 Actual", key: "ROD_BANK_POS_0_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 1 Ordered", key: "ROD_BANK_POS_1_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 1 Actual", key: "ROD_BANK_POS_1_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 2 Ordered", key: "ROD_BANK_POS_2_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 2 Actual", key: "ROD_BANK_POS_2_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 3 Ordered", key: "ROD_BANK_POS_3_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 3 Actual", key: "ROD_BANK_POS_3_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 4 Ordered", key: "ROD_BANK_POS_4_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 4 Actual", key: "ROD_BANK_POS_4_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 5 Ordered", key: "ROD_BANK_POS_5_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 5 Actual", key: "ROD_BANK_POS_5_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 6 Ordered", key: "ROD_BANK_POS_6_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 6 Actual", key: "ROD_BANK_POS_6_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 7 Ordered", key: "ROD_BANK_POS_7_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 7 Actual", key: "ROD_BANK_POS_7_ACTUAL", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 8 Ordered", key: "ROD_BANK_POS_8_ORDERED", format: :float, units: "%"},
    %Metric{name: "Control Rod Bank Pos 8 Actual", key: "ROD_BANK_POS_8_ACTUAL", format: :float, units: "%"},
